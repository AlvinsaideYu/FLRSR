...
if __name__ == '__main__':
    ...
    args.patch_size=256
    args.model='FSMamba1'
    args.pre_train = r'/root/Wz_Project/Super_Resolution_Reconstruction/HAUNet_RSISR/experiment/FSMambax2_WHU-RS19/model/model_best.pt'
    args.dir_data = r'/root/Wz_Project/Super_Resolution_Reconstruction/dataset/WHU-RS19/val/HR_x2'
    args.dir_out = r'/root/Wz_Project/Super_Resolution_Reconstruction/HAUNet_RSISR/experiment/FSMambax2_WHU-RS19/results'

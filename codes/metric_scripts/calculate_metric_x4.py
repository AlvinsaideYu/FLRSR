...
def main():
    ...
    folder_GT = r"D:\Wz_Project\dataset\AID-dataset\val\HR"
    folder_Gen = r'D:\Wz_Project\HAUNet_RSISR\experiment\FSMamba6x4_AID\results'
    ...
    for i, img_path in enumerate(img_list):
        ...
        # # 指定保存的文件路径
        file_path = r"D:\Wz_Project\HAUNet_RSISR\experiment\FSMamba6x4_AID\x4.xlsx"
